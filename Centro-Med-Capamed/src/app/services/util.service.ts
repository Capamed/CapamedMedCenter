...
export class UtilService {
  ...
  getInformationMenuOptions(): InformationMenuOptions[] {
    ...
    new InformationMenuOptions('ESP','Especialidades', 'specialties.jpg', 'Somos el único centro médico con más de 35 especialidades a disposición del usuario.'),
    ...
    new InformationMenuOptions('ENF','Enfermeros', 'nurse.webp', 'La enfermería abarca el cuidado autónomo y colaborativo de personas de todas las edades, familias, grupos y comunidades, enfermos o sanos y en todos los entornos.'),
    new InformationMenuOptions('PAC','Pacientes', 'pacient.jpeg', 'El paciente es aquella persona que sufre de dolor y malestar y, por ende, solicita asistencia médica y, está sometida a cuidados profesionales para la mejoría de su salud.'),
    new InformationMenuOptions('AGE','Agendar', 'agend.jpeg', 'La cita de atención médica es el trámite que permite agendar una atención, identificar al paciente, comprometer al especialista de la salud, proveer insumos y medicamentos y planificar la prestación de servicios de salud a un paciente en un área determinada de la medicina.'),
